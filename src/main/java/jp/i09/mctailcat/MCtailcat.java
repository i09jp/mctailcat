...
@Mod(modid = MCtailcat.MODID, version = TAG.Version, name = "MCtailcat", acceptedMinecraftVersions = "[1.7.10]")
public class MCtailcat {

    public static final String MODID = "mctailcat";
    public static final Logger LOG = LogManager.getLogger(MODID);

    @SidedProxy(clientSide = "jp.i09.mctailcat.ClientProxy", serverSide = "jp.i09.mctailcat.CommonProxy")
